...
def get_args(with_deepspeed: bool=False):
    ...
    parser.add_argument("--project_name", default="FGVC-PIM-master")
    parser.add_argument("--exp_name", default="exp")

    parser.add_argument("--c", default=r"H:\Transformer\FGVC-PIM-master-h\configs/CUB200_SwinT.yaml", type=str, help="config file path")
    
    ### about dataset
    parser.add_argument("--train_root", default=r"../datas/train/", type=str) # "../NABirds/train/"
    parser.add_argument("--val_root", default=r"../datas/test/", type=str)
    parser.add_argument("--data_size", default=384, type=int)
    parser.add_argument("--num_workers", default=2, type=int)
    parser.add_argument("--batch_size", default=64, type=int)

    ### model
    parser.add_argument("--model_name", default="swin-t", type=str, help='["resnet50", "swin-t", "vit", "efficient"]')
    ...
    parser.add_argument("--use_selection", default=False, type=bool)
    ...
    parser.add_argument("--use_combiner", default=False, type=bool)
